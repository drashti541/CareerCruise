...
<body>
    ...
    <section id="investment">
        ...
        <h4 class="heading-text">Find Right Investor for your Startup</h4>
            ...
            <!-- <form action="w-invest-1_2.php" method="post" >
                <div class="investment">
                    <div class="investor-update text-justify">
                        <h3><b>Angel Groups</b></h3>
                        <p>Angel groups have been increasing. They have become more popular and more organized. These are groups of angel investors who band together to make investments in startups. This enables them to invest with more confidence, with larger check sizes, and with lower exposure to risk.</p>
                    </div>
                    <div class="apply-btn">
                        <button class="btn" type="submit" name="investor">View Profiles</button>
                    </div>
            ...
            <form action="w-invest-1_3.php" method="post" >
                <div class="investment">
                    <div class="investor-update text-justify">
                        <h3><b>Accelerators & Incubators</b></h3>
                        <p>These vehicles can ultimately be a gateway to a variety of the types of investors on this list. If accepted into one of these programs you may receive anywhere from $10,000 to $120,000 in seed money to cultivate your idea and gain traction, while benefiting from additional knowledge and resources. If everything is going well, you’ll be pitching larger investors and be introduced to funding sources during their demo days that can help take you to the next level. Just be ready to hustle, these programs want to speed you on the way to the next stage quickly.</p>
                    </div>
                    <div class="apply-btn">
                        <button class="btn" type="submit" name="investor">View Profiles</button>
                    </div>
