...
if(isset($_POST['contactsub']))
{
   ...
   $mesg = $_POST['mesg'];
   $sql = "INSERT INTO contact_form (name, email, subject, phoneno, mesg) VALUES(:cname,:cemail,:csubject,:cnumber,:mesg)";
      ...
      $query->bindParam(':mesg',$mesg,PDO::PARAM_STR);
      $query->execute();
      $lastInsertId = $dbh->lastInsertId();
      if($lastInsertId) { $msg = " Contact Us Form Submitted Successfully"; } else { $error = " Something went wrong. Please try again"; } header( "index.php#contacts" ); }
?>
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <div class="col-lg-3">
            <div class="about-team">
              ...
              <p>Handles the database of the website</p>
                ...
                <div class="about-team-icon" id="contacts">
                  <a href=""><i class="fa-brands fa-facebook"></i></a>
                  <a href=""><i class="fa-brands fa-instagram"></i></a>
                  <a href=""><i class="fa-brands fa-twitter"></i></a>
                  <a href=""><i class="fa-brands fa-linkedin-in"></i></a>
    ...
    <div class="col-lg-6">
      <div class="contact-form">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <input type="number" name="cnumber" placeholder="Phone No." id="Timing">
            <textarea name="mesg" cols="10" rows="2" placeholder="Message"></textarea></br>
            <button type="submit" name="contactsub" class="contact-btn">Send Message</button>
          </form>
      </div>
    </div>
