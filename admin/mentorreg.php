...
if(isset($_GET['appr'])) {
	$id=$_GET['appr'];
	$sql = "UPDATE userlogin SET status = 'approved' WHERE id=:id";
	$query = $dbh->prepare($sql);
	$query -> bindParam(':id',$id, PDO::PARAM_STR);
	$query -> execute();
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									?>
										<tr>
											...
											<td><?php echo htmlentities($result->createdtime);?></td>
											<td><a href="reg-users.php?appr=<?php echo $result->id;?>" onclick="return confirm('Do you want to Approve Account');"><i class="fa fa-check"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
