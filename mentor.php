...
<body>
  <?php include 'head-foot/header.php'?>
        ...
        <div class="container" style="margin-top:5%">
            ...
            <div class="col-lg-6 main-content">
                ...
                <div class="search">
                    ...
                    <div class="find">
                        <button onclick="window.open('mentorall.php','_blank')" id="btn">Search</button>
        ...
        <div class="container" style="margin-top:6%">
            <div class="row justify-content-center" style="grid-row-gap: 60px;">
            <?php $sql = "SELECT * FROM mentorreg WHERE astatus = 'approved' LIMIT 3";
                ...
                <div class="col-lg-3 mentor-card">

                    <div class="mentor-imgbox">
                        <img src="admin/uploads/img/<?php echo htmlentities($result->mpp); ?>" alt="Image">
                    </div>
                    <h2><?php echo htmlentities($result->mfname);?></h2>
                    <h3><?php echo htmlentities($result->mjobr);?></h3>

                    <div class="mentor-icon">
                        <h4><?php echo htmlentities($result->mcallm);?></h4>
                    </div>

                    <div class="mentor-tag">
                        <p><?php echo htmlentities($result->mavai);?></p>
                    </div>                   
                    
                    <a href="mentorview.php?mentor=<?php echo htmlentities($result->id);?>" class="button">View Profile</a>
        ...
        <div class="container" style="width:75%">
            ...
            <div class="row provide-invest" style="padding:2% 0%;margin:0">
                <div class="col-lg-6 offset-md-3">
                    <button onclick="window.open('mentorall.php','_blank')" class="btn1">Find Mentors</button>
