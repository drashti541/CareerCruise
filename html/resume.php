            ...
            <div class="container  col-md-10  my-4 search">
                <div class="row cont text-center m-3">
                    <div class="row text-center">
                        ...
                        <div class="col-md-5 icon d-inline-block m-auto">
                            <img src="../images/PDF.png" alt="" srcset="">
                        </div>
                        <div class="col-md-5 d-inline-block m-auto">
                            <a href="../resume.pdf" target="_blank" class="btn btn-view d-block m-auto"><i class="fa fa-download"></i>View</a>
                        </div>
                    </div>
                </div>
                <div class="row cont text-center m-3">
