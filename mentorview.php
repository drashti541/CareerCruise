...
<body>
    <?php include 'head-foot/header.php'?>
        ...
        <header>
            <h1 class="heading-text">MENTOR DETAILS</h1>
            <?php $sql = "SELECT * FROM mentorreg WHERE id='$mentor'";
            ...
            <div class="container card">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 mentor-contact">
                        ...
                        <p><i class="fa-solid fa-phone"></i> <?php echo htmlentities($result->mavai); ?></p>
