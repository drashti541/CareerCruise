...
<body>
   ...
   <div class="container">
    ...
    <center><?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
	else if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?></center>
    <section id="features">
        <!-- title -->
        <div class="title">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="single_feature">
                                ...
                                <center><a href="jobpost.php" class="btn btn-view d-block m-auto">Post job</a></center>
                                <!-- feature-icon -->
