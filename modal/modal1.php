    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content popup">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="jobsearch.php" class="row p-3 form signup signupForm">
                        ...
                        <div class="col-md-6 p-3 inputgroup">
                            <input type="text" class="form-control" id="formGroupExampleInput1" placeholder="Last Name" required>
                                            ...
                                            <!-- <div class="footer text-align-centered">
                                                <button type="button" data-toggle="modal" data-target="#myModal2" class="btn d-block m-auto">SignUp</button>
                                            </div> -->
                                            <div class="footer text-align-centered">
                                                <button type="submit" name="submitdate" class="btn d-block m-auto">SignUp</button>
                                            </div>
                                    </form>
                                    <form method="post" action="jobsearch.php" class="row p-3 form login">
                                            <div class="col-md-12 p-3 inputgroup">
                                            ...
                                            <!-- <div class="footer text-align-centered">
                                                <button type="button" data-toggle="modal" data-target="#myModal2" class="btn d-block m-auto">Login</button>
                                            </div> -->
                                            <div class="footer text-align-centered">
